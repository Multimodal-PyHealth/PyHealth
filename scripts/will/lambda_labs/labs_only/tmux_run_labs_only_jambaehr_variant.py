...
cache_dir = "/home/ubuntu/mimiciv-data/pyhealth_cache_labs"
...
use_old_cache = False
use_wandb = True
wandb_project = f"pyhealth-multimodal-labs-seed-{seed}"
wandb_run_name = None  # defaults to "{model}_seed{seed}" if unset
cuda_visible_devices = "0"
session_name = f"jambaehr_labs_s{seed}"
...
log_dir = logs_dir
log_tag = f"jambaehr_labs_s{seed}"
