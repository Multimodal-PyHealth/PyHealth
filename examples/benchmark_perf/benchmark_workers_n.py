"""Benchmark script for MIMIC-IV mortality prediction across multiple num_workers.
...
Typical usage:
  ...
  python benchmark_workers_n.py --workers 1,4,8,12,16 --repeats 3
  python benchmark_workers_n.py --dev --workers 1,2,4
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Benchmark MIMIC-IV mortality prediction over multiple num_workers"
    )
    parser.add_argument(
        "--workers",
        type=parse_workers,
    ...
    parser.add_argument(
        "--output-csv",
        type=str,
        default="../benchmark_results_workers_sweep.csv",
    ...
    print("=" * 80)
    print("BENCHMARK: num_workers sweep")
