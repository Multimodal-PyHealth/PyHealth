#!/usr/bin/env bash
# HTCondor executable: activates the env and runs one metal cell script in the foreground.
# usage: cell.sh <metal script name>   (submitted via cell.sub; GPU comes from request_gpus)
set -euo pipefail
