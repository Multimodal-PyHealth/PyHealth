#!/usr/bin/env bash
# Paper cell: notes_labs x BottleneckTransformer x seed 1 — BERT UNFROZEN (trained end-to-end), no [CLS] cache.
# Identical to run_notes_labs_bottleneck_transformer_seed1.sh except --freeze-encoder is dropped.
...
NAME=notes_labs_bottleneck_transformer_seed1_unfrozen
