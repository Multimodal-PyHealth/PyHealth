...
def test_load_pretrained_into_downstream_transformer():
    ...
    # Manually invoke the load helper from the e2e script.
    import sys
    sys.path.insert(0, str(Path(__file__).parent.parent / "examples" / "mortality_prediction"))
    from unified_embedding_e2e_mimic4 import _load_pretrained_weights

    _load_pretrained_weights(downstream, ckpt_path)
